...
public:
    ...
    */
    static typename OutputImage::Pointer paste(
        typename InputImage::Pointer sourceImage, InputImageRegion sourceRegion,
        ...
        typename PasteImageFilterType::Pointer filter = PasteImageFilterType::New();
